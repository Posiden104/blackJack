...
if(players[1] == null) {
    ...
    message = '<div class="panel-body">'  + playerName + '</div><div class="panel-bet">' + players[1].bet + '</div><div class="panel-bet">' + players[1].money + '</div><div class="panel-default">' + players[1].status +'</div>';
