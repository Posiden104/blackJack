...
if(players[4] == null) {
    ...
    message = '<div class="panel-body">'  + playerName + '</div><div class="panel-score">' + players[4].Score + '</div><div class="panel-bet">' + players[4].bet + '</div><div class="panel-bet">' + players[4].money + '</div>';
