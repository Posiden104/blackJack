...
if(players[2] == null) {
    ...
    message = '<div class="panel-body">'  + playerName + '</div><div class="panel-score">' + players[2].Score + '</div><div class="panel-bet">' + players[2].bet + '</div><div class="panel-bet">' + players[2].money + '</div>';
