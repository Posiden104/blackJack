...
if(players[3] == null) {
    ...
    message = '<div class="panel-body">'  + playerName + '</div><div class="panel-score">' + players[3].Score + '</div><div class="panel-bet">' + players[3].bet + '</div><div class="panel-bet">' + players[3].money + '</div>';
